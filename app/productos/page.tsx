...
const ECOSYSTEM = [
  { icon: "👤", label: "Usuario" },
  { icon: "📱", label: "App usuario" },
  { icon: "🔍", label: "Motor biométrico" },
  { icon: "🎫", label: "Credencial digital" },
  { icon: "🚪", label: "App de puerta" },
];
              ...
              {PRODUCTS.map((product) => (
                ...
                >
                  <div className="flex items-start justify-between mb-4">
                    <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-violet-900/60 to-violet-700/30 border border-violet-500/20 flex items-center justify-center text-2xl">
                      {product.icon}
                    </div>
                ...
                {ECOSYSTEM.map((node, i) => (
                  <div key={node.label} className="flex items-center gap-3">
                    <div className="flex flex-col items-center gap-2">
                      <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-violet-900/50 to-violet-700/20 border border-violet-500/20 flex items-center justify-center text-2xl">
                        {node.icon}
                      </div>
